...
(function() {
	...
	var DOM = parent.tinymce.DOM, 
		Event = parent.tinymce.dom.Event, 
		each = parent.tinymce.each,
		$ = parent.$;

	// Create the editor plugin
	tinymce.create('tinymce.plugins.pwlPopups', {
			
		init : function(ed, url) {

			// Replace window manager
			ed.onBeforeRenderUI.add(function() {				
				ed.windowManager = new tinymce.PwlWindowManager(ed);
			});
		},
	...
	tinymce.create('tinymce.PwlWindowManager:tinymce.WindowManager', {
	...
	// Register plugin
	tinymce.PluginManager.add('pwlpopups', tinymce.plugins.pwlPopups);
})();
